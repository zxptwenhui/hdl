...
set_location_assignment PIN_R28   -to "ref_clkd(n)"            ; ## B21  FMC_HPC_GBTCLK1_M2C_N
...
set_location_assignment PIN_P33   -to rx_serial_data_c[1]      ; ## A02  FMC_HPC_DP1_M2C_P
set_location_assignment PIN_P32   -to "rx_serial_data_c[1](n)" ; ## A03  FMC_HPC_DP1_M2C_N
...
set_location_assignment PIN_M39   -to tx_serial_data_c[0]      ; ## A22  FMC_HPC_DP1_C2M_P (tx_serial_data_p[0])
set_location_assignment PIN_M38   -to "tx_serial_data_c[0](n)" ; ## A23  FMC_HPC_DP1_C2M_N (tx_serial_data_n[0])
set_location_assignment PIN_N37   -to tx_serial_data_c[1]      ; ## C02  FMC_HPC_DP0_C2M_P (tx_serial_data_p[3])
set_location_assignment PIN_N36   -to "tx_serial_data_c[1](n)" ; ## C03  FMC_HPC_DP0_C2M_N (tx_serial_data_n[3])
...
set_location_assignment PIN_K39   -to tx_serial_data_c[3]      ; ## A30  FMC_HPC_DP3_C2M_P (tx_serial_data_p[1])
set_location_assignment PIN_K38   -to "tx_serial_data_c[3](n)" ; ## A31  FMC_HPC_DP3_C2M_N (tx_serial_data_n[1])
...
set_location_assignment PIN_J37   -to tx_serial_data_d[0]      ; ## A34  FMC_HPC_DP4_C2M_P (tx_serial_data_p[0])
set_location_assignment PIN_J36   -to "tx_serial_data_d[0](n)" ; ## A35  FMC_HPC_DP4_C2M_N (tx_serial_data_n[0])
set_location_assignment PIN_H39   -to tx_serial_data_d[1]      ; ## A38  FMC_HPC_DP5_C2M_P (tx_serial_data_p[3])
set_location_assignment PIN_H38   -to "tx_serial_data_d[1](n)" ; ## A39  FMC_HPC_DP5_C2M_N (tx_serial_data_n[3])
set_location_assignment PIN_G37   -to tx_serial_data_d[2]      ; ## B36  FMC_HPC_DP6_C2M_P (tx_serial_data_p[2])
set_location_assignment PIN_G36   -to "tx_serial_data_d[2](n)" ; ## B37  FMC_HPC_DP6_C2M_N (tx_serial_data_n[2])
set_location_assignment PIN_F39   -to tx_serial_data_d[3]      ; ## B32  FMC_HPC_DP7_C2M_P (tx_serial_data_p[1])
set_location_assignment PIN_F38   -to "tx_serial_data_d[3](n)" ; ## B33  FMC_HPC_DP7_C2M_N (tx_serial_data_n[1])
...
set_location_assignment PIN_C3    -to tx_sync_1_c             ; ## G21  FMC_HPC_LA20_P
set_location_assignment PIN_C4    -to tx_sync_1_c(n)          ; ## G22  FMC_HPC_LA20_N
...
set_location_assignment PIN_H14   -to core_ckl_d(n)           ; ## G07  FMC_HPC_LA00_CC_N
set_location_assignment PIN_F4    -to tx_sync_1_d             ; ## G24  FMC_HPC_LA22_P
set_location_assignment PIN_G4    -to tx_sync_1_d(n)          ; ## G25  FMC_HPC_LA22_N
...
set_location_assignment PIN_C4    -to adrv9009_gpio_03_d       ; ## H08  FMC_HPC_LA02_N
