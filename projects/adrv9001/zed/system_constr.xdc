...
#set_property  -dict {PACKAGE_PIN K20  IOSTANDARD LVDS}      [get_ports dev_mcs_fpga_in_n]                 ; # C19 FMC_HPC0_LA14_N      IO_L11N_T1_SRCC_34
#set_property  -dict {PACKAGE_PIN K19  IOSTANDARD LVDS}      [get_ports dev_mcs_fpga_in_p]                 ; # C18 FMC_HPC0_LA14_P      IO_L11P_T1_SRCC_34
...
#set_property  -dict {PACKAGE_PIN A22  IOSTANDARD LVDS DIFF_TERM_ADV TERM_100}  [get_ports fpga_mcs_in_n]  ; # H38 FMC_HPC0_LA32_N      IO_L15N_T2_DQS_AD12N_35
#set_property  -dict {PACKAGE_PIN A21  IOSTANDARD LVDS DIFF_TERM_ADV TERM_100}  [get_ports fpga_mcs_in_p]  ; # H37 FMC_HPC0_LA32_P      IO_L15P_T2_DQS_AD12P_35
#set_property  -dict {PACKAGE_PIN C19  IOSTANDARD LVDS DIFF_TERM_ADV TERM_100}  [get_ports fpga_ref_clk_n] ; # G03 FMC_HPC0_CLK1_M2C_N  IO_L12N_T1_MRCC_35
#set_property  -dict {PACKAGE_PIN D18  IOSTANDARD LVDS DIFF_TERM_ADV TERM_100}  [get_ports fpga_ref_clk_p] ; # G02 FMC_HPC0_CLK1_M2C_P  IO_L12P_T1_MRCC_35
